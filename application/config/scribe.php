...
return [
    ...
    'title' => 'CatalystExplorer API Documentation',
    ...
    'auth' => [
        ...
        'extra_info' => 'Some endpoints require authentication. You can authenticate using Laravel Sanctum tokens or session-based authentication for web requests.',
    ],
    ...
    'strategies' => [
        ...
        'responses' => [
            // Disable response calls to avoid database/UUID issues during generation
