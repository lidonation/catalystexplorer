...
const SearchVariants = ({
    ...
    const variantItems = [
        ...
        { key: 'proposals', label: t('proposals.proposals') },
        {
            ...
            label: t('ideascaleProfiles.ideascaleProfiles'),
        },
    ...
    const handleSelection = (newValue: string[]) => {
        ...
        const individualOptions = variantItems
            .filter((item) => item.key !== allKey)
            .map((item) => item.key);
        const selectedIndividualOptions = newValue.filter(
            (item) => item !== allKey,
        );
                                ...
                                return (
                                    ...
                                    >
                                        <label
                                            ...
                                            className="flex-1 cursor-pointer capitalize select-none"
                                        >
                                            {variant.label}
                                        </label>
                                        <Checkbox
