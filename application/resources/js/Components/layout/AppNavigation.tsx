    ...
    const navItems = [
        {
            ...
            title: t('home'),
            icon: (isActive: boolean) => <HomeIcon className={isActive ? 'text-primary-100' : 'text-dark'} />,
        },
        {
            href: useLocalizedRoute('proposals.index'),
            title: t('proposals.proposals'),
            icon: (isActive: boolean) => <NoteIcon className={isActive ? 'text-primary-100' : 'text-dark'} />,
        },
        {
        ...
        },
        {
            ...
            title: t('charts'),
            icon: (isActive: boolean) => <ChartIcon className={isActive ? 'text-primary-100' : 'text-dark'} />,
        },
        {
