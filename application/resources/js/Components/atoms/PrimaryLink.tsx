...
export default function PrimaryLink({
    ...
    return (
        <Link
            {...props}
            href={href}
            className={`hover:bg-background-tertiary hover:text-content-secondary focus:bg-background-accent active:bg-background-tertiary bg-primary active:text-content-secondary text-content-light inline-flex items-center justify-center rounded-md px-2 py-1.5 tracking-widest transition duration-150 ease-in-out focus:ring-0 focus:ring-offset-0 focus:outline-hidden ${
                disabled || loading
