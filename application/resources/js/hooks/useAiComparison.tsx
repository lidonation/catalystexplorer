...
export const useAiComparison = () => {
    ...
    const generateComparison = async (proposalIds: string[]) => {
        setState({
            isGenerating: true,
            results: null,
            error: null,
...
1. Executive Summary for each proposal
...
5. Comparative analysis highlighting the relative strengths of each proposal`,
                    },
                ],
                temperature: 0.7,
                max_tokens: 2000,
