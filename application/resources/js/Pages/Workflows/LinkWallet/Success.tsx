...
export default function Success({
    ...
    return (
        ...
        >
            <Content>
                <div className="bg-background mx-auto my-14 flex h-3/4 w-[calc(100%-4rem)] items-center justify-center rounded-lg p-8 md:w-3/4">
                    <div className="flex h-full w-full flex-col items-center justify-center gap-3 rounded p-8 md:w-3/4 md:shadow-sm">
                        ...
                        >
                            <span>
                                {t(
                                    'workflows.linkWallet.successfullyLink',
                                )}{' '}
                            </span>
