  ...
  return (
    <div className="grid w-full grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-5">
      {ideascaleProfiles.map((index)=> (
        <div className="w-full rounded-xl bg-background p-4 shadow-xs" key={index}>
        <div className="mb-2 w-full">
          ...
          {/* Name skeleton */}
          <div className="mt-2 h-6 w-32 animate-pulse rounded-sm bg-gray-200" />
        </div>
        ...
        <div className="border-t-2 border-border-secondary">
          ...
          <div className="flex w-full justify-between pb-4 pt-2">
            ...
            <div className="h-4 w-8 animate-pulse rounded-sm bg-gray-200" />
          </div>
