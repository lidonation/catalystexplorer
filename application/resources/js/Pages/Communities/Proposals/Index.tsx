...
export default function Proposals({community, proposals, ownProposals, collaboratingProposals}: DashboardPageProps) {
    return (
        <CommunityLayout community={community} coProposalsCount={collaboratingProposals}
            ...
            <WhenVisible data="proposals" fallback={<ProposalMiniCardLoader/>}>
                <RelatedProposals
                    ...
                    className='proposals-wrapper w-full grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3'
                />
            </WhenVisible>
        </CommunityLayout>
    );
