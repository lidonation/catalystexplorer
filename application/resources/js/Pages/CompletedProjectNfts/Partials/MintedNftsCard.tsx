...
const MintedNftsCard: React.FC<MintedNftsCardProps> = ({
    ...
    return (
        <div className="group relative h-[355px] w-full max-w-[325px] cursor-pointer overflow-hidden rounded-xl shadow-md transition-all duration-300 hover:shadow-xl">
            ...
            <div className="bg-background absolute right-0 bottom-0 left-0 z-20 m-4 flex translate-y-4 flex-col items-center gap-2 rounded-[20px] p-4 opacity-0 shadow-lg transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100">
                ...
                <a
                    ...
                    target="_blank "
                    className="hover:bg-background-tertiary hover:text-content-secondary focus:bg-background-accent active:bg-background-tertiary bg-primary active:text-content-secondary text-content-light relative inline-flex w-auto cursor-pointer items-center justify-center rounded-md p-1 px-3 text-sm tracking-widest whitespace-nowrap transition duration-150 ease-in-out focus:ring-0 focus:ring-offset-0 focus:outline-hidden"
                >
