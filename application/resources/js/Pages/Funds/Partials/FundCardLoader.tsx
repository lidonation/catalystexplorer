const FundCardLoader = () => {
    ...
    return (
        <div className="grid w-full grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {fundCards.map((index) => (
                <div className="w-full rounded-lg bg-background p-4 sm:p-6 shadow-sm flex flex-col sm:flex-row gap-6 sm:gap-8" key={index}>
                    ...
                    <div className="flex-grow flex flex-col sm:w-2/3 justify-center space-y-4 sm:space-y-2">
                        {/* Total Allocated Skeleton */}
                        <div>
                            <p className="h-4 w-32 animate-pulse rounded bg-gray-200 mb-2" />
