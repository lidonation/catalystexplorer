    ...
    return (
        <div className="rounded-md bg-background p-8 shadow-xs lg:p-16">
            ...
            <div className="grid w-full grid-cols-2 justify-between gap-4 lg:grid-cols-5">
                <div>
                    <div className="lg:w-15 h-4 w-8 animate-pulse rounded-xs bg-dark opacity-30 lg:h-8" />
                    <div className="mt-2 h-8 w-8 animate-pulse rounded-xs bg-dark opacity-30 lg:h-4 lg:w-20" />
                </div>
                <div>
                    <div className="lg:w-15 h-4 w-10 animate-pulse rounded-xs bg-dark opacity-30 lg:h-8" />
                    <div className="mt-2 h-8 w-12 animate-pulse rounded-xs bg-dark opacity-30 lg:h-4 lg:w-20" />
                </div>
                <div>
                    <div className="lg:w-15 h-4 w-10 animate-pulse rounded-xs bg-dark opacity-30 lg:h-8" />
                    <div className="mt-2 h-8 w-12 animate-pulse rounded-xs bg-dark opacity-30 lg:h-4 lg:w-20" />
                ...
                <div>
                    <div className="lg:w-15 h-4 w-12 animate-pulse rounded-xs bg-dark opacity-30 lg:h-8" />
                    <div className="mt-2 h-8 w-12 animate-pulse rounded-xs bg-dark opacity-30 lg:h-4 lg:w-20" />
                </div>
                <div>
                    <div className="lg:w-15 h-4 w-12 animate-pulse rounded-xs bg-dark opacity-30 lg:h-8" />
            ...
            <div className="mt-4 flex justify-end px-12 sm:mb:4">
                <div className="w-15 h-8 w-12 animate-pulse rounded-xs bg-dark opacity-30" />
            </div>
