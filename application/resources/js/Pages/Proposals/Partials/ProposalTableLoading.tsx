...
const ProposalTableLoading: React.FC = () => {
    return (
        <div
            className="w-full overflow-x-auto rounded-t-lg border border-gray-200 shadow-[0_-1px_4px_0_rgba(0,0,0,0.05)]"
            data-testid="proposal-table-loading-container"
        >
            <div
                className="inline-block min-w-full overflow-hidden"
                data-testid="proposal-table-loading-wrapper"
            >
                <table
                    className="min-w-full divide-y divide-gray-200 overflow-hidden rounded-lg border border-gray-200"
                    data-testid="proposal-table-loading"
                >
                    <thead
                        className="bg-background-lighter"
                        data-testid="proposal-table-loading-header"
                    >
