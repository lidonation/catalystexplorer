                ...
                >
                    <div className="h-full animate-pulse space-y-4">
                        ...
                        <div className="space-y-2">
                            <div className="h-4 w-3/4 rounded-sm bg-background-light"></div>
                            <div className="h-4 rounded-sm bg-background-light"></div>
                            <div className="h-4 w-5/6 rounded-sm bg-background-light"></div>
                        </div>
                        <div className="flex justify-between">
                            <div className="h-4 w-24 rounded-sm bg-background-light"></div>
