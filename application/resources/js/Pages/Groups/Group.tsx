            ...
            <header className="relative">
                ...
                <div className="container px-4 relative -mt-10">
                    ...
                    <Image
                        ...
                        size="ml-8 w-24 h-24 sm:w-32 sm:h-32 md:w-40 md:h-40 rounded-full"
                    />
                    <div className="ml-2 pt-10 sm:pt-12">
                        <Title className="text-xl sm:text-2xl font-bold text-content drop-shadow-lg">
                        {group.name}
                        </Title>
