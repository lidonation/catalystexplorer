...
export default function SupportCxBanner() {
    ...
    return (
        ...
        >
            <div className="text-content-darker md: col-span-3 flex w-full flex-col gap-8 lg:border-r lg:pr-8">
                <div>
                ...
                <div>
                    ...
                    <Paragraph size="lg">
                        {t('activeFund.supportUsProposalSubtitle')}
                    </Paragraph>
                </div>
            ...
            <div className="col-span-2 flex h-full w-full items-center justify-center">
                <div className="grid h-fit w-full grid-cols-1 gap-2">
                    <div className="flex flex-col gap-4">
                        <div>
                            <Title level="2">Our Track Record</Title>
                            <div className="flex flex-row flex-wrap justify-start gap-x-4">
                                <KeyValue
                                    className="flex flex-row-reverse flex-wrap items-center justify-between gap-2"
                                ...
                                />
                                <KeyValue
                                    className="flex flex-row-reverse flex-nowrap items-center justify-between gap-2"
                                    valueKey="Catalyst Checkins Iss."
                                    value="~440"
                                />
                                <KeyValue
                                    className="flex flex-row-reverse flex-nowrap items-center justify-between gap-2"
                                ...
                                <KeyValue
                                    className="flex flex-row-reverse flex-nowrap items-center justify-between gap-2"
                                    valueKey="Catalyst Spreadsheet Wranngled"
                                    value="13"
                                />
                                <KeyValue
                                    className="flex flex-row-reverse flex-nowrap items-center justify-between gap-2"
                                    valueKey="Free API Requests Served"
                                    value="~1,400,000"
                                />
                            </div>
                        </div>
