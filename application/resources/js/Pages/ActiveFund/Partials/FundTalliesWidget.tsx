...
const FundTalliesWidgetComponent: React.FC<FundTalliesWidgetProps> = ({
    ...
    return (
        <div className="bg-background w-full rounded-lg border border-content-light shadow-sm">
            <div className="m-8 border-b border-content-light px-6 py-4">
                <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
                    <div className="flex-1">
                        <Title className="font-bold text-xl" level="4">
            ...
            {shouldShowNoRecords() ? (
                ...
                <div className={`m-8 bg-background rounded-xl shadow-[0px_3px_4px_0px_rgba(0,0,0,0.03)] outline outline-1 outline-offset-[-1px] outline-content-light flex flex-col justify-start items-start overflow-x-auto overflow-hidden`}>
