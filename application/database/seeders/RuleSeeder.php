            ...
            foreach ($reader->getSheetIterator() as $sheet) {
                foreach ($sheet->getRowIterator() as $rowIndex => $row) {
                    ...
                    $batchData[] = [
                        ...
                        'old_model_id'    => $record['old_model_id'] ?: null,
                        'model_type'      => $record['model_type'] ?: null,
                        'created_at'      => !empty($record['created_at']) ? $record['created_at'] : now(),
                        'updated_at'      => !empty($record['updated_at']) ? $record['updated_at'] : now(),
                        'deleted_at'      => !empty($record['deleted_at']) ? $record['deleted_at'] : null,
                    ];
