...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // Only perform backfill if users.id is uuid AND users.old_id exists to map legacy integers
        if ($usersIdType === 'uuid' && $hasOldId) {
            ...
            // No safe mapping available (either users.id is bigint or users.old_id is missing). Skip.
        }
    }
