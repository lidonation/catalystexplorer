...
class ProposalFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'title' => json_encode(['en' => $this->faker->words($this->faker->numberBetween(1, 10), true)]),
            ...
            'problem' => json_encode($this->faker->sentences($this->faker->numberBetween(2, 15))),
            'solution' => json_encode($this->faker->sentences($this->faker->numberBetween(2, 15))),
            'experience' => json_encode($this->faker->sentences($this->faker->numberBetween(2, 15))),
            'content' => json_encode($this->faker->paragraphs($this->faker->numberBetween(3, 15))),
