...
function UpdatePasswordForm({
  ...
  return /* @__PURE__ */ jsxs("section", { className, children: [
    /* @__PURE__ */ jsxs("header", { children: [
      /* @__PURE__ */ jsx("h2", { className: "text-2 font-medium text-content", children: "Update Password" }),
      /* @__PURE__ */ jsx("p", { className: "mt-1 text-4 text-content", children: "Ensure your account is using a long, random password to stay secure." })
    ] }),
