...
class MilestonePoaReviews extends Resource
{
    /**
    ...
    public function fields(NovaRequest $request): array
    {
        return [
            ...
            Textarea::make(__('Content Comment'))
                ->required(),
            ...
            Boolean::make(__('Content Approved'))
                ->sortable()
                ->filterable(),

            BelongsTo::make(__('Proof Of Accomplishment'), 'poa', MilestonePoas::class),
        ];
    }
